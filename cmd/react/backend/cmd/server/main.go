...
import (
	...
	"github.com/joetifa2003/inertigo/cmd/react/backend/models/pages"
...
func main() {
	...
	bundler, err := vite.New(
		os.DirFS("node_modules/frontend/dist"),
	...
	i, err := inertia.New(
		...
		inertia.WithRootHtmlPathFS(os.DirFS("node_modules/frontend"), "index.html"),
		inertia.WithSSR(true, func() (inertia.SSREngine, error) {
			return qjs.New(
				qjs.WithSrcPath("node_modules/frontend/dist/server/ssr.js"),
	...
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		err = i.Render(w, r, "index", pages.Index{
			...
			Reviews: props.NewDeferred(func(ctx context.Context) ([]string, error) {
				...
				return []string{"Greatt", "Awesome", "Cool"}, nil
			}),
		})
		if err != nil {
